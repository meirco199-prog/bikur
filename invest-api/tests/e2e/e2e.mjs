...
await check('shadow', '#/today', ['מודל צל', 'הישן (A)', 'יחסי-ענף (B)', 'הסכמה בפעולה', 'התפלגות היום', 'אגרסיבי מסונן']);
await check('aggressive', '#/today', ['מסלול אגרסיבי', 'מול SPY', 'ירידה מקסימלית', 'חמישה מסלולי השקעה']);
