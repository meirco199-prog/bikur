...
export const KEY_NAMES = ['TWELVEDATA_KEY', 'TIINGO_KEY', 'FINNHUB_KEY', 'FMP_KEY', 'ALPHAVANTAGE_KEY', 'FRED_KEY', 'EODHD_KEY', 'TELEGRAM_BOT_TOKEN', 'TELEGRAM_CHAT_ID', 'RESEND_KEY', 'ALERT_EMAIL', 'ANTHROPIC_API_KEY', 'EDGAR_UA', 'CRON_BATCH'];
