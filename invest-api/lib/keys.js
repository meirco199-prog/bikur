...
export const KEY_NAMES = ['FINNHUB_KEY', 'FMP_KEY', 'ALPHAVANTAGE_KEY', 'FRED_KEY', 'EODHD_KEY', 'TELEGRAM_BOT_TOKEN', 'TELEGRAM_CHAT_ID', 'RESEND_KEY', 'ALERT_EMAIL', 'ANTHROPIC_API_KEY', 'EDGAR_UA', 'CRON_BATCH'];
export const KEY_LABELS = { FINNHUB_KEY: 'Finnhub (quote, אנליסטים, חדשות) — חינם', FRED_KEY: 'FRED (מאקרו, VIX, ריבית) — חינם', ALPHAVANTAGE_KEY: 'Alpha Vantage (סנטימנט, ETF, insider) — חינם 25/יום', FMP_KEY: 'FMP (screener, תחזיות, יעדי מחיר) — חינם 250/יום', EODHD_KEY: 'EODHD (בורסת ת"א) — בתשלום', TELEGRAM_BOT_TOKEN: 'Telegram bot token', TELEGRAM_CHAT_ID: 'Telegram chat id', RESEND_KEY: 'Resend (אימייל) API key', ALERT_EMAIL: 'כתובת אימייל להתראות', ANTHROPIC_API_KEY: 'Anthropic API key (עוזר AI; אחרת Workers AI)', EDGAR_UA: 'User-Agent ל-SEC (שם + אימייל)', CRON_BATCH: 'נכסים לכל הפעלת cron' };
