...
export const SEED_RULES = [
  ...
  { p: ['פועלים-משכנ', 'משכנתא', 'משכנת'], cat: 'משכנתא', space: 'personal' },
  { p: ['הראלהלואה', 'הלואה', 'הלוואה'], cat: 'הלוואות', space: 'personal' },
  { p: ['הראל פנסיה', 'פנסיה וגמ', 'קרן השתלמות', 'גמל'], cat: 'השקעות', space: 'personal' },
  { p: ['ני"ע', 'ניע-קניה', 'ניע-מכירה', 'דיבידנד'], cat: 'השקעות', space: 'personal' },
  ...
  { p: ['משכנתא', 'משכנת'], cat: 'משכנתא', space: 'personal' },
